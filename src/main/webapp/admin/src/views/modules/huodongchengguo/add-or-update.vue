<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动过程" prop="huodongguocheng">
          <el-input v-model="ruleForm.huodongguocheng" 
              placeholder="活动过程" clearable  :readonly="ro.huodongguocheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动过程" prop="huodongguocheng">
              <el-input v-model="ruleForm.huodongguocheng" 
                placeholder="活动过程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="活动报告" prop="huodongbaogao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.huodongbaogao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huodongbaogao" label="活动报告" prop="huodongbaogao">
                    <span v-html="ruleForm.huodongbaogao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodongleixing = true;
          ...
          if(o=='huodongguocheng'){
            this.ruleForm.huodongguocheng = obj[o];
	    this.ro.huodongguocheng = true;
            continue;
          }
	    ...
	    this.ro.xiangguanfujian = true;
          ...
          if(o=='huodongbaogao'){
            this.ruleForm.huodongbaogao = obj[o];
	    this.ro.huodongbaogao = true;
            continue;
          }
          if(o=='faburiqi'){
	...
	this.ruleForm.huodongbaogao = this.ruleForm.huodongbaogao.replace(reg,'../../../ssm92d05/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huodongchengguo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huodongchengguoCrossAddOrUpdateFlag = false;
                  this.parent.search();
