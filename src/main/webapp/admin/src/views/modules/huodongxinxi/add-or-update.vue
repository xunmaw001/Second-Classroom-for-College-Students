<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动目标" prop="huodongmubiao">
          <el-input v-model="ruleForm.huodongmubiao" 
              placeholder="活动目标" clearable  :readonly="ro.huodongmubiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动目标" prop="huodongmubiao">
              <el-input v-model="ruleForm.huodongmubiao" 
                placeholder="活动目标" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主办单位" prop="zhubandanwei">
          <el-input v-model="ruleForm.zhubandanwei" 
              placeholder="主办单位" clearable  :readonly="ro.zhubandanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主办单位" prop="zhubandanwei">
              <el-input v-model="ruleForm.zhubandanwei" 
                placeholder="主办单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodongleixing = true;
          ...
          if(o=='huodongmubiao'){
            this.ruleForm.huodongmubiao = obj[o];
	    this.ro.huodongmubiao = true;
            continue;
          }
          if(o=='zhubandanwei'){
	...
	this.ruleForm.huodongneirong = this.ruleForm.huodongneirong.replace(reg,'../../../ssm92d05/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
